 ...
 */
#define NOZZLE_X          -35   //black sphinx = -34  //red = -35
#define NOZZLE_Y          -7   //black sphinx = -17  //red = -7
 ...
 */
 //Super X Right Side = 50/RIGHT, 5/FRONT   //  rev 6 Duct BLTouch Mount = 39/RIGHT, 47/FRONT
#define SENSOR_LEFT        0
#define SENSOR_RIGHT       39     
#define SENSOR_FRONT       47     
 ...
 * (how to calibrate: https://toms3d.org/2014/04/06/3d-printing-guides-calibrating-your-extruder/)
 */
#define E1_STEPS      96 // Stock extruder. If you have a Tevo Titan, try 400 then calibrate
 ...
 */
#define  hot_Kp 25.12     // Old 21.74   // Stock 11.20   // New 25.12
#define  hot_Ki 2.04      // Old 1.65    // Stock 0.60    // New 2.04
#define  hot_Kd 77.17     // Old 71.68   // Stock 52.53   // New 77.17
 ...
 */
#define  bed_Kp 172.68    // Stock 841.21    // New 272.17    // MOSFET 172.68
#define  bed_Ki 31.94     // Stock 165.63    // New 45.46     // MOSFET 31.94
#define  bed_Kd 233.42    // Stock 1068.13   // New 407.40    // MOSFET 233.42
 ...
 */
#define XTRA_BED_LEFT     0 //25  //26// Distance nozzle can move towards the left past X = 0
#define XTRA_BED_RIGHT    0 //38  //39// Distance nozzle can move towards the right past X = 200

/**
 * Extra movement of Y axis. Can help with probing more of the bed.
 * Set both to 0 (zero) if you do not have a Z-Probe.
 */
#define XTRA_BED_FRONT    0  //5// Distance bed can move towards the front past Y = 200
#define XTRA_BED_BACK     0  //5// Distance bed can move towards the back past Y = 0
 ...
 */
#if ENABLED(DUAL_EXTRUDER)
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, E0_STEPS, E1_STEPS }
#else
 ...
 */
#define DEFAULT_ACCELERATION          1000    //Stock 500    // X, Y, Z and E acceleration for printing moves
 ...
 */
#define DEFAULT_XJERK                  8.0    //Stock 4.0
#define DEFAULT_YJERK                  8.0    //Stock 7.0
